...
export const GET_CATEGORY_SUCCESS = 'GET-CATEGORY_SUCCESS'
...
export const GET_CATEGORY_BYID_FAIL = 'GET_CATEGORY_BYID_FAIL'
export const GET_CATEGORY_BYID_RESET = 'GET_CATEGORY_BYID_RESET'
